...
/*--Sign in page--*/
let userField = document.getElementsById("userField").value;
...
let incomeField = document.getElementById("incomeField").value;
...
const apiKey = '2ef8b464631c4007cd9d3e547b1e497d9afe4'; // Replace with your RestDB API key
const databaseId = 'YOUR_DATABASE_ID'; // Replace with your RestDB database ID
const collectionName = 'users'; // Replace with your collection name

const apiUrl = `https://${databaseId}.restdb.io/rest/${collectionName}`;
...
// Similar functions for updateUser and deleteUser can be implemented
